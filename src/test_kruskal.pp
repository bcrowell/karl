...
def test_motion_kruskal_vs_schwarzschild(t0,r0,theta,phi,v,duration):
  ...
  x0s = [t0,r0,i,j,k] # initial point in Schwarzschild coordinates
  x0k = [a0,b0,i,j,k] # ... in Kruskal
...
duration = 0.2
test_motion_kruskal_vs_schwarzschild(t0,r0,theta,phi,v,duration)
