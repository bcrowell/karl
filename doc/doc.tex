...
of lensing. Format of stars table is $[\alpha,\phi,I,ln_temp]$, where $\phi$ is azimuthal angle, $I$ is
brightness (first normalized to zero magnitude, but then taking $f$ into account), and ln_temp is
