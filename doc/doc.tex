...
\texttt{transform.kruskal\_to\_time\_zero}. There seems to be a problem where null trajectories fly
out along a horizon, and we get problems with numerical precision in Christoffel symbols.
In ray-tracing, we don't care about t, so I'm going to try simply zeroing out t at various times.
